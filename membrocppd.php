          ...
          <nav class="navbar navbar-expand-lg custom_nav-container ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="consulta.php"><i class="fa fa-line-chart"></i> Consultar Progressão</a>
                </li>     
                <li class="nav-item">
                  <a class="nav-link" href="lista_usuarios.php">Lista de Usuários</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#"><i class="fa fa-calendar"></i> Histórico</a>
                </li>-->
                <li class="nav-item">
        ...
        <div class="col">
            <div class="card mb-4 rounded-3 shadow-sm">
              ...
              <div class="card-body ">
                ...
                <div id="botao-card">
                <a type="button" class="w-50 btn btn-lg btn-primary" href="avaliacoes_pend.php">Avaliar</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card mb-4 rounded-3 shadow-sm">
              ...
              <div class="card-body">
                <div align="left">
                  ...
                  <p><i class="fa fa-arrow-right"></i> Caso não esteja dinponível ainda será informada a data da próxima progressão.</p>
                </div>
                <div id="botao-card">
