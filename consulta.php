...
?>
 ...
 <!--condição para consultar progressão -->
<?php

// Verifica se o índice 'requerimento_existente' está definido em $_SESSION
if (isset($_SESSION['requerimento_existente'])) {
  $requerimento_existente = $_SESSION['requerimento_existente'];
} else {
  // Se não estiver definido, atribui um valor padrão (por exemplo, 0)
